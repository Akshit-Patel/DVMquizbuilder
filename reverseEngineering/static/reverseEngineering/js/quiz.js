...
function getNoOfQuestions(){
    var data = $.ajax( {
        type: 'GET',
        url: `/quiz-portal/reverseEngineering/get_no_of_questions`,
        data: {
        },
    ...
    var data = $.ajax( {
        ...
        success: function(data){   
           ...
           if (!data.message) {
            ...
            window.open("/quiz-portal/reverseEngineering/submitquiz/", "_self");
           }
        }
    });    
}
...
function getQuestionStatus(){
    var data = $.ajax( {
        type: 'GET',
        url: `/quiz-portal/reverseEngineering/gqs`,
        data: {
        },
...
function getQuestion(quesNo){   
    var data = $.ajax( {
        type: 'GET',
        url: `/quiz-portal/reverseEngineering/get_question/${quesNo}`,
        data: {
        },
        success: function(data) {
            if(data.mcq_flag){
...
function sendAnswer(quesNo,key){
    if(is_mcq){
        var data = $.ajax( {
            type: 'POST',
            url: `/quiz-portal/reverseEngineering/store_response/`,
            data: {
                "queskey" : quesNo,
                "anskey" : key
            },
...
function sendAnswer_Review(quesNo, key){
    var data = $.ajax( {
        type: 'POST',
        url: '/quiz-portal/reverseEngineering/atar/',
        data: {
            "queskey" : quesNo,
            "anskey" : key
        },
...
function sendReview(quesNo){
    var data = $.ajax( {
        type: 'POST',
        url: '/quiz-portal/reverseEngineering/atr/',
        data: {
            "queskey" : quesNo
        },
        success: function(data) {             
...
function sendAttempted(quesNo){
    var data = $.ajax( {
        type: 'POST',
        url: '/quiz-portal/reverseEngineering/ata/',
        data: {
            "queskey" : quesNo
        },
        success: function(data) {             
...
function sendUnattempted(quesNo){
    var data = $.ajax( {
        type: 'POST',
        url: '/quiz-portal/reverseEngineering/atna/',
        data: {
            "queskey" : quesNo
        },
        success: function(data) {             
...
function sendClearResponse(quesNo){
    var data = $.ajax( {
        type: 'POST',
        url: '/quiz-portal/reverseEngineering/delete_response/',
        data: {
            "queskey" : quesNo
        },
        success: function(data) {             
