...
function getNoOfQuestions(){
    var data = $.ajax( {
        type: 'GET',
        url: `/quiz-portal/mechanix/get_no_of_questions`,
        data: {
        },
    ...
    var data = $.ajax( {
        ...
        success: function(data){   
           ...
           if (!data.message) {
            ...
            window.open("/quiz-portal/mechanix/submitquiz/", "_self");
           }
        }
    });    
}
...
function getQuestion(quesNo){   
    var data = $.ajax( {
        type: 'GET',
        url: `/quiz-portal/mechanix/get_question/${quesNo}`,
        data: {
        },
        success: function(data) {
            if(data.mcq_flag){
...
function sendAnswer(quesNo,key){
    if(is_mcq){
        var data = $.ajax( {
            type: 'POST',
            url: `/quiz-portal/mechanix/store_response/`,
            data: {
                "queskey" : quesNo,
                "anskey" : key
            },
...
function sendClearResponse(quesNo){
    var data = $.ajax( {
        type: 'POST',
        url: '/quiz-portal/mechanix/delete_response/',
        data: {
            "queskey" : quesNo
        },
        success: function(data) {             
